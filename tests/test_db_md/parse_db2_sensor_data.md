...
try:
    ...
    for i in range(6):
        ...
        print(f'  AB线电压: {Uab_0:7.2f} V  BC线电压: {Uab_1:7.2f} V  CA线电压: {Uab_2:7.2f} V')
        print(f'  A相电压:  {Ua_0:7.2f} V  B相电压:  {Ua_1:7.2f} V  C相电压:  {Ua_2:7.2f} V')
        print(f'  A相电流:  {I_0:7.2f} A  B相电流:  {I_1:7.2f} A  C相电流:  {I_2:7.2f} A')
        print(f'  总功率:   {Pt:7.2f} kW  A相功率: {Pa:7.2f} kW  B相功率: {Pb:7.2f} kW  C相功率: {Pc:7.2f} kW')
    ...
    for i, vib_offset in enumerate(vib_offsets):
        ...
        print(f'  速度幅值: VX={VX:5d} mm/s  VY={VY:5d} mm/s  VZ={VZ:5d} mm/s')
        print(f'  位移幅值: DX={DX:5d} um     DY={DY:5d} um     DZ={DZ:5d} um')
        print(f'  频率:     HZX={HZX:5d} Hz    HZY={HZY:5d} Hz    HZZ={HZZ:5d} Hz')
        print()
